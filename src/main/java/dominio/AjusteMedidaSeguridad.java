...
@Entity
@Table(name="ajuste_medida_seguridad")
public class AjusteMedidaSeguridad implements Serializable{
	...
	public AjusteMedidaSeguridad() {}

	public AjusteMedidaSeguridad(Integer id, LocalDate fechaInicioVigencia, LocalDate fechaFinVigencia,
