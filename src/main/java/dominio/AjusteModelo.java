...
@Entity
@Table(name="ajuste_modelo")
public class AjusteModelo implements Serializable{
	...
	public AjusteModelo(Integer id, LocalDate fechaInicioVigencia, LocalDate fechaFinVigencia, Double valorPorcentual,
