...
@Entity
@Table(name="ajuste_tipo_cobertura")
public class AjusteTipoCobertura implements Serializable{
	...
	public AjusteTipoCobertura() {}

	public AjusteTipoCobertura(Integer id, LocalDate fechaInicioVigencia, LocalDate fechaFinVigencia,
